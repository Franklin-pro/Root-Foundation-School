    ...
    <section class="pt-10 overflow-hidden bg-gray-50 md:pt-0 sm:pt-16 2xl:pt-16">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid items-center grid-cols-1 md:grid-cols-2">
              <div>
                  <h2 class="text-3xl font-bold leading-tight text-blue-600 sm:text-4xl lg:text-5xl ">Hey 👋 We're <br class="block sm:hidden" />Foundation</h2>
                  ...
                  <p class="mt-4 text-xl text-gray-600 md:mt-8">
                      ...
                      <br class="block sm:hidden" />Ask me on <a href="https://www.instagram.com/g_wayne_1/?hl=en" target="_blank" title="" class="transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline">Instagram</a>
                  </p>
              </div>
              ...
              <div class="relative">
                  ...
                  <img class="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src="../assets/people.png" alt="" />
              </div>
          </div>
      </div>
  </section>
