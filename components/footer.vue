    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
               <h1 class="text-2xl text-blue-600 font-black">ROOT FOUNDATION</h1>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About Us </a>
                    </li>
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blogs </a>
                    </li>
                </ul>
            </div>
        ...
        <p class="text-sm text-center text-gray-600">copyright &copy; {{ new Date().getFullYear() }}, All Rights Reserved by Root Foundation</p>
    </div>
</section>
