  ...
  <div>
    <UCard>
        ...
        <div class="mt-2.5 relative">
          <input type="text" name="" id="" placeholder="Role" v-model="blogs.blogStatus"
            class="block w-full p-3 placeholder-gray-500 transition-all duration-200 border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
               ...
               <div class="mt-2.5 relative">
          <input type="text" name="" id="" placeholder="Course" v-model="blogs.blogDescription"
            class="block w-full p-3 placeholder-gray-500 transition-all duration-200 border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
        </div>
          </div>
        </div>
      ...
      <div class="pt-2 flex gap-3">
        <button type="button" @click="updateBlog" class="w-full bg-blue-500  flex items-center gap-3 justify-center text-white py-2 rounded hover:bg-blue-600">
...
import type { Blogs, UpdateBlog as UpdateBlogType } from '~/type';
...
// Function to handle closing the update card
function closeCard() {
  emit('close');
}
</script>
